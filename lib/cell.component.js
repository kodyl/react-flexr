...
var _staticProperties$baseMethods$media = require('./defaults');
...
var Cell = (function (_React$Component) {
  ...
  _createClass(Cell, [{
    ...
    value: function render() {
      ...
      this.styles = [style, styling.cellBase, { padding: '0 ' + gutter }];

      var responsiveSize = findResponsiveSize(_staticProperties$baseMethods$media.media, this.props);
      if (responsiveSize) {
...
_assign2['default'](Cell.prototype, _staticProperties$baseMethods$media.baseMethods);
_assign2['default'](Cell, _staticProperties$baseMethods$media.staticProperties);
