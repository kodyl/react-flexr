...
var _doubleUnit = require('./utils/double-unit');

var _doubleUnit2 = _interopRequireWildcard(_doubleUnit);

var Component = _React2['default'].Component;
var Type = _React2['default'].PropTypes;

var GridStyles = _StyleSheet2['default'].create({
  base: {
    display: 'flex',
    flexWrap: 'wrap',
    listStyle: 'none',
    padding: 0,
    margin: '0 -' + _staticProperties$baseMethods$variables.variables.gutter + ' ' + _doubleUnit2['default'](_staticProperties$baseMethods$variables.variables.gutter)
  },
  top: {
    alignItems: _flexAlignments2['default'].top
  },
  bottom: {
    alignItems: _flexAlignments2['default'].bottom
  },
  center: {
    alignItems: _flexAlignments2['default'].center
  }
...
var Grid = (function (_Component) {
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      this.styles = [GridStyles.base, gutter ? { margin: '0 -' + gutter + ' ' + _doubleUnit2['default'](gutter) } : null, align ? GridStyles[align] : null, style].concat(Array.isArray(styles) ? styles : [styles]);
