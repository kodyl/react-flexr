...
var GridStyles = _StyleSheet2['default'].create({
  base: {
    ...
    listStyle: 'none',
    padding: 0,
    margin: '0 -' + _staticProperties$baseMethods$variables.variables.gutter + ' ' + _staticProperties$baseMethods$variables.variables.gutter
  },
  top: {
...
var Grid = (function (_Component) {
  ...
  _createClass(Grid, [{
    ...
    value: function render() {
      ...
      this.styles = [GridStyles.base, gutter ? { margin: '0 -' + gutter + ' ' + gutter } : null, align ? GridStyles[align] : null, style, styles];
