...
describe('GridComponent', function () {
  it('has correct base styling', function () {
    ...
    _assert2['default'].equal(styles.margin, '0 -' + _variables.variables.gutter + ' ' + _doubleUnit2['default'](_variables.variables.gutter));
  });
...
describe('CellComponent', function () {
  ...
  it('accepts grow params', function () {
    var styles = extractStyles(_React2['default'].createElement(_Cell2['default'], { grow: false }));
    _assert2['default'].equal(styles.flex, '0 1 auto');
  });
